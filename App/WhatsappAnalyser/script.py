...
def data_preprocessing(data):
    """
        Preprocessing a whole pandas message dataframe
    """
...
def load_whatsapp_conversation(file_content):
    """
        Take a whatsapp discussion file content and process it into a pandas dataframe
        The result dataframe store :
            - date
            - person
            - message
    """
...
def main(whatsapp_file_content):
    """
        This function take a whatsapp discussion content and make a prediction for the while discussion
    """
    Discussion = load_whatsapp_conversation(whatsapp_file_content)
    original_message = Discussion['Message']
    Discussion['Message'] = data_preprocessing(Discussion['Message'])

    # Load tokenzer from the pickle file
    with open('../Training/Tokenizer/tokenizer.pickle', 'rb') as file:
